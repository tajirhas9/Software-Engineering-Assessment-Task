...
export interface IModuleState {
	patients: IPatients[] | null
}

export interface IModuleGetters {
	patients(state: IModuleState): IPatients[] | null
}
...
export type TModuleMutations<S = IModuleState> = {
	[EModuleMutation.SET_PATIENTS](state: S, devices: IPatients[] | null): void
}
